...
def pak_protocol(scores, labels, threshold, max_k=100):
    ...
    return area_under_f1, max_f1_k, k_max, preds_for_max, fprs, tprs, f1_k_0, fpr_k_0, tpr_k_0
...
def evaluate(score, label, validation_thresh=None):
    ...
    for thresh in thresholds:
        f1, max_f1_k, k_max, best_preds, fprs, tprs, f1_k_0, fpr_k_0, tpr_k_0 = pak_protocol(score, label, thresh)
    ...
    if validation_thresh:
        f1, max_f1_k, max_k, best_preds, _, _, f1_k_0, fpr_k_0, tpr_k_0 = pak_protocol(score, label, validation_thresh)
    else:    
        f1 = max(f1s)
